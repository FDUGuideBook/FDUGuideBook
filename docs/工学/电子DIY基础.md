...
### [3D打印](泔水桶/3D打印.md) :material-hexagon-slice-6:
...
### [PCB焊接](泔水桶/PCB焊接.md) :material-hexagon-slice-6:

\*简介

### CAD软件 :material-hexagon-slice-3:

- SolidWorks
- AutoCAD

### 复刻一份开源项目 :material-hexagon-slice-6: :material-tools:

\*简介（主要目的是跑一遍加工流程，如PCB发加工，焊接，3D打印外壳，以及需要其它发加工的实体。需要推荐几个开源良好的项）

### [PCB设计](泔水桶/PCB设计.md) :material-hexagon-slice-3:
